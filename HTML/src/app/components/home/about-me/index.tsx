                ...
                <div className="border-x border-primary/10 bg-[url('/images/about-me/about-me-bg.svg')] bg-cover bg-center bg-no-repeat">
                    <div className="flex flex-col gap-9 sm:gap-12 max-w-3xl mx-auto px-4 sm:px-7 py-11 md:py-20">
                        <div className="flex flex-col gap-4">
                            ...
                            <h5 className="text-secondary font-normal">Currently Geospatial Engineer at INCATech, on U.S. Postal Inspection Service (USPIS) work. Previously DRT Strategies (CDC), National Grid, the U.S. Census Bureau, C2 Solutions, and Booz Allen Hamilton (DHS). Studying for AWS Solutions Architect – Associate. On the side I run <a href="https://vectorscopeai.com" target="_blank" rel="noopener noreferrer" className="hover:underline">Vector Scope AI</a>, a playground for experimental GIS and cloud projects.</h5>
                        </div>
                        <div className="flex flex-col gap-4">
