                ...
                <div className="border-x border-primary/10 bg-[url('/images/about-me/about-me-bg.svg')] bg-cover bg-center bg-no-repeat">
                    <div className="flex flex-col gap-9 sm:gap-12 max-w-3xl mx-auto px-4 sm:px-7 py-11 md:py-20">
                        <div className="flex flex-col gap-4">
                            ...
                            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-[32px]">I&apos;m Jonathan, a Solutions Architect–track GIS engineer with 15+ years designing <span className="border-b-2">cloud and enterprise geospatial systems</span> for CDC, utilities, and federal clients. I choose platforms and services — ArcGIS, AWS, and spatial data pipelines — so maps become scalable products.</h2>
                            <h5 className="text-secondary font-normal">Currently Geospatial Engineer at INCATech. Previously DRT Strategies (CDC), National Grid, U.S. Census Bureau, C2 Solutions, and Booz Allen Hamilton (FEMA/DHS). Studying for AWS Solutions Architect – Associate; shipping cloud-backed tools at <a href="https://vectorscopeai.com" target="_blank" rel="noopener noreferrer" className="hover:underline">Vector Scope AI</a>.</h5>
                        </div>
                        <div className="flex flex-col gap-4">
