...
const nightlyPlan: NightPlan[] = [
  ...
  { night: 20, week: 3, title: "VPN + Direct Connect + TGW", minutes: [60, 30, 30], blocks: ["Site-to-Site VPN vs DX vs TGW", "PrivateLink vs VPC peering", "Diagram 3 exam scenarios"], lab: "Theory night — no deploy" },
  { night: 21, week: 3, title: "Week 3 review", minutes: [20, 40, 60], blocks: ["Draw 3-tier VPC + ALB + Aurora", "30 timed practice questions", "Tear-down checklist for Aurora if done"], lab: undefined },

  { night: 22, week: 4, title: "Lab 3A — ElastiCache", minutes: [30, 60, 30], blocks: ["Redis use cases + Lambda-in-VPC tradeoff", "Cache GET wiki pages (or CloudFront TTL)", "CloudWatch latency comparison"], lab: "Global Ski Atlas frontend — lambda/wiki-api" },
  { night: 23, week: 4, title: "Lab 3B — Athena on Iceberg", minutes: [20, 70, 30], blocks: ["Athena workgroup + Glue catalog", "SQL: resort counts by country", "Athena vs Redshift decision table"], lab: "Global Ski Atlas backend — register_iceberg.py" },
  { night: 24, week: 4, title: "Lab 3C — Route 53 advanced", minutes: [30, 60, 30], blocks: ["Weighted / failover / latency routing", "Health check on witcoskitech.com", "Test subdomain routing lab"], lab: "Cloud Resume Challenge DNS" },
  { night: 25, week: 4, title: "CloudFront + API performance", minutes: [30, 60, 30], blocks: ["Cache behaviors for /api/* paths", "API Gateway throttling", "Build CloudWatch dashboard"], lab: "Global Ski Atlas frontend — wiki-api-production.md" },
  { night: 26, week: 4, title: "EC2 + EBS + Spot", minutes: [40, 50, 30], blocks: ["EBS gp3/io2/st1/sc1 matrix", "Optional: Spot EC2 PMTiles job vs Fargate", "Cost table from AWS_ECS_DEPLOYMENT.md"], lab: "Global Ski Atlas backend — WORLD_SCALE.md" },
  { night: 27, week: 4, title: "Integration services", minutes: [50, 40, 30], blocks: ["EventBridge vs SQS vs Kinesis vs Step Functions", "AppSync awareness", "25 practice questions (performance)"], lab: undefined },
  { night: 28, week: 4, title: "Week 4 review", minutes: [20, 40, 60], blocks: ["Storage class decision tree (S3/EBS/EFS)", "30 practice questions", "Update architecture notes"], lab: undefined },

  { night: 29, week: 5, title: "Lab 4A — S3 lifecycle + cost", minutes: [30, 60, 30], blocks: ["Lifecycle rules on old pipeline prefixes", "Cost Explorer top services", "AWS Budget alert"], lab: "globalskiatlas-backend-k8s-output" },
  { night: 30, week: 5, title: "Lab 4B — Fargate right-sizing", minutes: [40, 50, 30], blocks: ["Compare ecs-task-pipeline-*.json sizes", "Savings Plans vs Spot vs On-Demand", "Compute Optimizer read"], lab: "Global Ski Atlas backend — aws/" },
  { night: 31, week: 5, title: "Lab 4C — Step Functions capstone", minutes: [20, 80, 20], blocks: ["State machine: ECS → SQS → Lambda → SNS", "Error handling + Catch states", "Deploy sam-pipeline-orchestrator"], lab: "Global Ski Atlas backend — new SAM stack" },
  { night: 32, week: 5, title: "Architecture write-up", minutes: [30, 60, 30], blocks: ["Document GSA frontend + backend stacks", "One security/resilience/cost win per tier", "Link labs to Well-Architected pillars"], lab: "Portfolio artifact" },
  { night: 33, week: 5, title: "Practice exam 1", minutes: [10, 130, 20], blocks: ["Timed full mock (130 min)", "Review every wrong answer", "List weak services"], lab: undefined },
  { night: 34, week: 5, title: "Weak-area drill", minutes: [20, 60, 40], blocks: ["Re-study top 3 missed domains", "40 targeted questions", "Redo 5 missed scenarios aloud"], lab: undefined },
  { night: 35, week: 5, title: "Practice exam 2 + schedule", minutes: [10, 130, 20], blocks: ["Second timed mock — target ≥75%", "Schedule real exam if ready", "Tear down NAT/Aurora/ElastiCache labs"], lab: undefined },
];
