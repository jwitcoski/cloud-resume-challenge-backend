"""Generate private-sector resume Word document."""
import re
...
INPUT = Path(__file__).parent / "public" / "Jonathan_Witcoski_Resume_2026.md"
OUTPUT = Path(__file__).parent / "public" / "Jonathan_Witcoski_Resume_2026.docx"
DOWNLOADS = Path.home() / "Downloads" / "Jonathan_Witcoski_Resume_2026.docx"
